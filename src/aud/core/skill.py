...
CAPABILITIES: tuple[tuple[str, str, str], ...] = (
    ...
    ("downmix", "deterministic", "Output-format stage: fold a multichannel programme down to one channel."),
    ("resample", "deterministic", "Output-format stage: convert to a target sample rate."),
